...
if (( $NON_HEAP_SIZE_MB < $MIN_NON_HEAP_SIZE_MB )); then
    export NON_HEAP_SIZE_MB=${MIN_NON_HEAP_SIZE_MB}
...
export JAVA_OPTS=${JAVA_OPTS:--showversion ${JAVA_TMP_OPTS} ${DBG_AGENT} ${PROFILER_AGENT} ${JAVA_HEAP_OPTS} ${JAVA_GC_OPTS} ${JAVA_OOM_OPTS} ${JAVA_USER_OPTS}}
